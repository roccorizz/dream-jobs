...
const Navbar = () => {
    ...
    return (
        <header>
            {/* ......Mini navbar start...... */}
            <div className="py-3 bg-[#BFDB38] hidden sm:block">
            ...
            >
                <div className="flex justify-between items-center container mx-auto px-5">
                    ...
                    <div>
                        ...
                        >
                            <figure>
                                <img src={logo} alt="logo" className="shrink-0 w-20" />
                            </figure>
                        </NavLink>
                    </div>
                            ...
                            <div className="flex gap-2">
                                {accessToken && user?.email ? (
                                    ...
                                    <>
                                        ...
                                        <div className="flex items-center btn rounded-none border-0 duration-700 bg-primary hover:bg-accent text-white font-bold px-4">
                                            <label htmlFor="toggle" className={isJobSeeker ? "mr-2 font-bold" : "mr-2"}>
                                                Job Seeker
                                            </label>
                                            <div className="relative" onClick={handleToggle}>
                                                <input id="toggle" type="checkbox" className="hidden" />
                                                <div className="toggle__line w-12 h-4 bg-gray-400 rounded-full shadow-inner"></div>
                                                <div
                                                    className={
                                                        isJobSeeker
                                                            ? "toggle__dot absolute w-6 h-4 bg-blue-500 rounded-full shadow inset-y-0 left-0 transition-transform transform translate-x-0"
                                                            : "toggle__dot absolute w-6 h-4 bg-blue-500 rounded-full shadow inset-y-0 right-4 transition-transform transform translate-x-full"
                                                    }
                                                ></div>
                                            </div>
                                            <label htmlFor="toggle" className={!isJobSeeker ? "ml-2 font-bold" : "ml-2"}>
                                                Job Poster
                                            </label>
                                            {!isJobSeeker && (
                                                <form className="mt-4">
                                                    ...
                                                    <button type="submit" className="bg-blue-500 text-white px-4 py-2 rounded-lg mt-4" onClick={handleButtonClick}>Post a Job</button>
                                                    {showForm && (
                                                        <form>
                                                            <label>
                                                                Job Title:
